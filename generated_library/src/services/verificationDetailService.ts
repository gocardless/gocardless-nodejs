...
public async create(requestParameters: VerificationDetailCreateRequest, idempotencyKey: string='', customHeaders: Types.JsonMap={}): Promise<VerificationDetailResponse> {
...
public async *all(
  ...
  do {
    ...
    for (let verificationdetail of list.verification_details) {
