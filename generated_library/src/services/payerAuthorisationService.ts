...
public async create(requestParameters: PayerAuthorisationCreateRequest, idempotencyKey: string='', customHeaders: Types.JsonMap={}): Promise<PayerAuthorisationResponse> {
...
public async update(identity: string, requestParameters: PayerAuthorisationUpdateRequest): Promise<PayerAuthorisationResponse> {
const urlParameters = [
  { key: 'identity', value: identity},
];
  const requestParams = {
