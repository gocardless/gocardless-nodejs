...
public async create(requestParameters: MandateImportEntryCreateRequest, idempotencyKey: string='', customHeaders: Types.JsonMap={}): Promise<MandateImportEntryResponse> {
