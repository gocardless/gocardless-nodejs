...
public async create(requestParameters: CreditorBankAccountCreateRequest, idempotencyKey: string='', customHeaders: Types.JsonMap={}): Promise<CreditorBankAccountResponse> {
...
public async *all(
  ...
  do {
    ...
    for (let creditorbankaccount of list.creditor_bank_accounts) {
