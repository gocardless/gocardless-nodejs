...
public async create(requestParameters: SchemeIdentifierCreateRequest, idempotencyKey: string='', customHeaders: Types.JsonMap={}): Promise<SchemeIdentifierResponse> {
...
public async *all(
  ...
  do {
    ...
    for (let schemeidentifier of list.scheme_identifiers) {
