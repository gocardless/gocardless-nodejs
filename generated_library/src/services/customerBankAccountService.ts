...
public async create(requestParameters: CustomerBankAccountCreateRequest, idempotencyKey: string='', customHeaders: Types.JsonMap={}): Promise<CustomerBankAccountResponse> {
...
public async update(identity: string, requestParameters: CustomerBankAccountUpdateRequest): Promise<CustomerBankAccountResponse> {
const urlParameters = [
  { key: 'identity', value: identity},
];
  const requestParams = {
