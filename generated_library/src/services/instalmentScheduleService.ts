...
public async createWithDates(requestParameters: InstalmentScheduleCreateWithDatesRequest, idempotencyKey: string='', customHeaders: Types.JsonMap={}): Promise<InstalmentScheduleResponse> {
...
public async createWithSchedule(requestParameters: InstalmentScheduleCreateWithScheduleRequest, idempotencyKey: string='', customHeaders: Types.JsonMap={}): Promise<InstalmentScheduleResponse> {
...
public async update(identity: string, requestParameters: InstalmentScheduleUpdateRequest): Promise<InstalmentScheduleResponse> {
const urlParameters = [
  { key: 'identity', value: identity},
];
  const requestParams = {
