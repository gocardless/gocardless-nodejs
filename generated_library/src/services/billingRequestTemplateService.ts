...
public async *all(
  ...
  do {
    ...
    for (let billingrequesttemplate of list.billing_request_templates) {
...
public async create(requestParameters: BillingRequestTemplateCreateRequest, idempotencyKey: string='', customHeaders: Types.JsonMap={}): Promise<BillingRequestTemplateResponse> {
...
public async update(identity: string, requestParameters: BillingRequestTemplateUpdateRequest): Promise<BillingRequestTemplateResponse> {
const urlParameters = [
  { key: 'identity', value: identity},
];
  const requestParams = {
