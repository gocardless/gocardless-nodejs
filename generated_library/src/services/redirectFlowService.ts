...
public async create(requestParameters: RedirectFlowCreateRequest, idempotencyKey: string='', customHeaders: Types.JsonMap={}): Promise<RedirectFlowResponse> {
...
public async complete(identity: string, requestParameters: RedirectFlowCompleteRequest): Promise<RedirectFlowResponse> {
const urlParameters = [
  { key: 'identity', value: identity},
];
  const requestParams = {
