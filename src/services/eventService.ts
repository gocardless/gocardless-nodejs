...
interface EventListRequest {
  ...
  //  ID of a [mandate](#core-endpoints-mandates). If specified, this endpoint
  //  will return all events for the given mandate.
  ...
  //  ID of a [payment](#core-endpoints-payments). If specified, this endpoint
  //  will return all events for the given payment.
  ...
  //  `payout`, `refund`, `scheme_identifier`, `subscription` or
  //  `outbound_payment` parameters.
