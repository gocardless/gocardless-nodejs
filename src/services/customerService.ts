...
interface CustomerCreateRequest {
  ...
  //  are provided. For Canadian customers, the use of a `company_name` value will
  //  mean that any mandate created from this customer will be considered to be a
  ...
  //  "fr", "de", "pt", "es", "it", "nl", "da", "nb", "sl", "sv" are supported. If
  //  this is not provided, the language will be chosen based on the
