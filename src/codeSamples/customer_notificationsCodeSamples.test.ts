...
describe('CustomerNotifications Code Samples', () => {
  ...
  test('handle code sample executes without error', async () => {
    // Convert :param placeholders to regex wildcards for flexible matching
    const stubUrl = '/customer_notifications/:identity/actions/handle';
    ...
    const responseBody = { customer_notifications: {} };
    for (let i = 0; i < 5; i++) {
